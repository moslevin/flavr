...
typedef struct _BreakPoint
{
    ...
    uint32_t    u32Addr;            //!< Address of the breakpoint
} BreakPoint_t;
 ...
 *
 * \param u32Addr_ Address of the breakpoint.
 */
 ...
 *
 * \param u32Addr_ Address of the breakpoint to delete.
 */
 ...
 *
 * \param u32Addr_  Address (in flash) to check for breakpoint on.
